    ...
    constructor() {
        ...
        this.startRecording = () => {
            ...
            navigator.mediaDevices
                ...
                if ((_a = this._recordingEvents) === null || _a === void 0 ? void 0 : _a.afterStartRecording)
                    (_b = this._recordingEvents) === null || _b === void 0 ? void 0 : _b.afterStartRecording();
        ...
        this.stopRecording = () => {
            var _a, _b, _c;
            (_a = this._mediaRecorder) === null || _a === void 0 ? void 0 : _a.stop();
            this._stopTimer();
            ...
            if ((_b = this._recordingEvents) === null || _b === void 0 ? void 0 : _b.afterStopRecording)
            ...
            if (this._processor && this._mic) {
                ...
                (_c = this._activeStream) === null || _c === void 0 ? void 0 : _c.getAudioTracks().forEach((track) => track.stop());
            }
        };
        ...
        this.resume = () => {
            var _a, _b;
            this._isPausedSubject.next(false);
            (_a = this._mediaRecorder) === null || _a === void 0 ? void 0 : _a.resume();
            this._recordingStateSubject.next('recording');
            AudioContext.resumeAnalyze();
            void this._audioContext.resume();
            this._startTimer();
            if ((_b = this._recordingEvents) === null || _b === void 0 ? void 0 : _b.onResume)
                this._recordingEvents.onResume();
        };
        this.pause = () => {
            var _a, _b;
            this._isPausedSubject.next(true);
            (_a = this._mediaRecorder) === null || _a === void 0 ? void 0 : _a.pause();
            this._recordingStateSubject.next('paused');
            AudioContext.pauseAnalyze();
            void this._audioContext.suspend();
            this._stopTimer();
            if ((_b = this._recordingEvents) === null || _b === void 0 ? void 0 : _b.onPause)
...
const AudioVisualizer = {
    ...
    visualize(type, options) {
        this[`visualize${type || 'SineWave'}`](Object.assign(Object.assign({}, defaultOptions), options));
    }
};
...
class NgxMicRecorderComponent {
    ...
    ngAfterViewInit() {
        AudioVisualizer.visualize(this.visualizationType, Object.assign({ canvas: this.canvas.nativeElement }, this.visualizationOptions));
    }
    ngOnDestroy() {
        var _a;
